...
const Home = () => {
  ...
  const { banners, categories, shoes, lifestyleProducts, driftProducts } =
    homeData;
    ...
    <div className="">
      ...
      <section className="relative w-full">
        <div className="absolute inset-x-0 bottom-6 flex justify-center gap-8 text-sm lg:bottom-40 lg:left-[570px] lg:text-2xl lg:justify-start">
          <button className="border-2 border-white text-white px-6 py-2 font-bold rounded-lg shadow-black hover:bg-pink-700 hover:text-white hover:scale-110 transition-all duration-700">
            <Link to="/Men">SHOP MEN</Link>
          </button>
          <button className="border-2 border-white text-white px-4 py-2 font-bold rounded-lg shadow-black hover:bg-pink-700 hover:text-white hover:scale-110 transition-all duration-700">
      ...
      <section className="w-full bg-white py-8">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-center md:justify-between gap-6">
          {[
            ...
            <button
              key={brand}
              className="text-xl md:text-2xl lg:text-3xl font-semibold tracking-wide hover:opacity-70 hover:bg-gray-200 px-2 py-4"
            >
              <Link to={`/${brand}`}>
                {brand === "361-sport"
                  ? "361°"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {homeData.shoes.map((shoe) => (
            ...
            >
              ...
              <p className="absolute top-3 right-3 text-red-700 bg-white px-2 py-1 text-sm font-semibold">
                -{shoe.discount}%
              </p>
              <p
