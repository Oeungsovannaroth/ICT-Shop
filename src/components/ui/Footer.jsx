      ...
      <footer className="w-full bg-white border-t pt-10 pb-6 text-gray-800">
        ...
        <div className="max-w-7xl mx-auto mt-10 px-4">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <img
              src="https://super-duper.biz/wp-content/uploads/Untitled-1.jpg"
              className="h-8"
              alt="ABA Pay"
            />
            <img
              src="https://m.eyeofriyadh.com/news_images/2020/07/1c58492c218f6.jpg"
              className="h-8"
              alt="Visa"
            />
            <img
              src="https://p7.hiclipart.com/preview/130/79/694/mastercard-credit-card-mastercard-logo-png.jpg"
              className="h-8"
              alt="MasterCard"
            />
            <img
            ...
            />
            <img
              src="https://hrincjobs-pro.s3.amazonaws.com/media/public/filer_public/b2/44/b2445f30-f856-4958-8b21-c76754717a1a/wing.png"
              className="h-8"
              alt="Wing Bank"
            />
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRSOYT7e94q9uJr9eaV4bXs0VJEWkhgpSA4bpdlrirzBpXZJkEIPstB5Nbe_4LtmMQ0Z9g&usqp=CAU"
              className="h-8"
              alt="Bank Transfer"
            />
            <img
